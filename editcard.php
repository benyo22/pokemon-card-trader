...
if(!$auth->isAdmin($auth) || !isset($_GET['id'])){
    die("Only admins can edit new cards or id is not set! Please go back! <a href=\"home.php\">Home</a>");
}
else{
    $validid = false;
    ...
    if(!$validid){
        die("Id is not valid, please go back! <a href=\"home.php\">Home</a>");
    }
}
                ...
                <div class="pokemon-card">
                    ...
                    <div class="details">
                        <h2>                            
                            ...
                            <input type="text" id="name" name="name" value="<?= $_POST['name'] ?? $card['name'] ?>">
                            <?php if (isset($errors['name'])) : ?>
                                <span class="error"><?= $errors['name'] ?></span>
                            <?php endif; ?>

                            <label for="description">Description</label>
                            <input type="text" id="description" name="description" value="<?= $_POST['description'] ?? $card['description'] ?>">
                            <?php if (isset($errors['description'])) : ?>
                                <span class="error"><?= $errors['description'] ?></span>
                            <?php endif; ?>

                            <label for="image">Image</label>
                            <input type="text" id="image" name="image" value="<?= $_POST['image'] ?? $card['image'] ?>">
                        ...
                        <span class="card-type"><span class="icon">🏷</span>
                            ...
                            <input type="text" id="type" name="type" value="<?= $_POST['type'] ?? $card['type'] ?>">
                        </span>
                        ...
                        <span class="attributes">
                            <span class="card-hp"><span class="icon">❤</span> 
                                ...
                                <input type="number" id="hp" name="hp" value="<?= $_POST['hp'] ?? $card['hp'] ?>">
                            </span>

                            <span class="card-attack"><span class="icon">⚔</span> 
                                <label for="attack">Attack</label>
                                <input type="number" id="attack" name="attack" value="<?= $_POST['attack'] ?? $card['attack'] ?>">
                            </span><br>

                            <span class="card-defense"><span class="icon">🛡</span> 
                                <label for="defense">Defense</label>
                                <input type="number" id="defense" name="defense" value="<?= $_POST['defense'] ?? $card['defense'] ?>">
                            </span>
                        </span>
                    </div>
                    <div class="edit">
                        <span class="card-price"><span class="icon">💰</span> 
                            ...
                            <input type="number" id="price" name="price" value="<?= $_POST['price'] ?? $card['price'] ?>">
                        </span>
